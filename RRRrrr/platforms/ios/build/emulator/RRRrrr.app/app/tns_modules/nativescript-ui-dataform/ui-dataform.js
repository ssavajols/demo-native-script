...
var TKDataFormDelegateImplementation = (function (_super) {
    ...
    /**
         * Called when a row with the corresponding property is selected.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidSelectEditorForProperty = /**
         * Called when a row with the corresponding property is selected.
         */
    function (dataForm, editor, property) {
        var args = {
    ...
    /**
         * Called when a row with the corresponding property is deselected.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidDeselectEditorForProperty = /**
         * Called when a row with the corresponding property is deselected.
         */
    function (dataForm, editor, property) {
        var args = {
    ...
    /**
         * Called after a property is edited.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidEditProperty = /**
         * Called after a property is edited.
         */
    function (dataForm, property) {
        var args = {
    ...
    /**
         * Called after a property is validated.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidValidatePropertyEditor = /**
         * Called after a property is validated.
         */
    function (dataForm, property, editor) {
    ...
    /**
         * Called after validate method has been called to notify that the process has ended.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidFinishValidation = /**
         * Called after validate method has been called to notify that the process has ended.
         */
    function (dataForm, result) {
    ...
    /**
         * Called after commit method has been called to notify that the process has ended.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidFinishCommit = /**
         * Called after commit method has been called to notify that the process has ended.
         */
    function (dataForm, result) {
    ...
    /**
         * Called when a property has to be validated.
         */
    TKDataFormDelegateImplementation.prototype.dataFormValidatePropertyEditor = /**
         * Called when a property has to be validated.
         */
    function (dataForm, property, editor) {
        var entityProperty = this._owner.get().getPropertyByName(property.name);
    ...
    /**
         *  Called once when the data form creates its editors. This method lets you to set properties that are not going to be changed.
         */
    TKDataFormDelegateImplementation.prototype.dataFormSetupEditorForProperty = /**
         *  Called once when the data form creates its editors. This method lets you to set properties that are not going to be changed.
         */
    function (dataForm, editor, property) {
        var entityProperty = this._owner.get().getPropertyByName(property.name);
    ...
    */
    /**
        *  Called when the data is reloaded in the native RadDataForm component (reloadData). This method lets you to set the PropertyChanged callbacks for all {N} properties.
        */
    TKDataFormDelegateImplementation.prototype.dataFormDidFinishEditorIntitialization = /**
        *  Called when the data is reloaded in the native RadDataForm component (reloadData). This method lets you to set the PropertyChanged callbacks for all {N} properties.
        */
    function (dataForm) {
    ...
    /**
         * Called before an editor is displayed to the screen or after validation. This method lets you change the visual styles and setting of TKDataFormEditor object.
         */
    TKDataFormDelegateImplementation.prototype.dataFormUpdateEditorForProperty = /**
         * Called before an editor is displayed to the screen or after validation. This method lets you change the visual styles and setting of TKDataFormEditor object.
         */
    function (dataForm, editor, property) {
        var entityProperty = this._owner.get().getPropertyByName(property.name);
    ...
    /**
         * This method lets you change the visual styles and setting of TKEntityPropertyGroupView object.
         */
    TKDataFormDelegateImplementation.prototype.dataFormUpdateGroupViewForGroupAtIndex = /**
         * This method lets you change the visual styles and setting of TKEntityPropertyGroupView object.
         */
    function (dataForm, groupView, groupIndex) {
    ...
    /**
         * Called just before a property value will be committed to the business object.
         */
    TKDataFormDelegateImplementation.prototype.dataFormWillCommitProperty = /**
         * Called just before a property value will be committed to the business object.
         */
    function (dataForm, property) {
        var entityProperty = this._owner.get().getPropertyByName(property.name);
    ...
    /**
         * Called after a property value is committed to the business object.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidCommitProperty = /**
         * Called after a property value is committed to the business object.
         */
    function (dataForm, property) {
    ...
    /**
         * Called after a group is collapsed.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidCollapseGroupView = /**
         * Called after a group is collapsed.
         */
    function (dataForm, groupView) {
    ...
    /**
         * Called after a group is expanded.
         */
    TKDataFormDelegateImplementation.prototype.dataFormDidExpandGroupView = /**
         * Called after a group is expanded.
         */
    function (dataForm, groupView) {
        var groupName = groupView != null && groupView.group != null ? groupView.group.name : null;
    ...
    /**
         * Initializes a view controller specific for a given view controller editor.
         */
    TKDataFormDelegateImplementation.prototype.dataFormInitViewControllerForEditor = /**
         * The header for the corresponding group.
         */ 
    // todo: uncomment , the bug with null view is fixed
    // public dataFormViewForHeaderInGroup(dataForm: TKDataForm, groupIndex: number): any { //TKEntityPropertyGroupTitleView
    ...
    /**
         * Initializes a view controller specific for a given view controller editor.
         */
    function (dataForm, viewController, editor) {
...
var RadDataForm = (function (_super) {
    ...
    // Helpers
    // Helpers
    RadDataForm.getFontWithProperties = 
    // Helpers
    function (fontName, size, style) {
        var font = null;
...
var PropertyGroup = (function (_super) {
    ...
    // todo: consider if these properties need handles at all
    PropertyGroup.prototype.onNameChanged = 
    // todo: consider if these properties need handles at all
...
var 
// Converters
StringToDateConverter = (function (_super) {
